...
Downoad the source code, you will need to install NodeJS/NPM and install the Neutralino CLI and create-dmg packages
```npm install -g @neutralinojs/neu create-dmg```
